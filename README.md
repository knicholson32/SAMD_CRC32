...
Provide a pointer to the data, the size of the data in bytes (must be in 32bit word form), and a pointer to a variable to save the result to. Any addressable variable is acceptable (program memory, ram, EEPROM, etc.).
```c++
